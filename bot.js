...
client.user.setGame(`-bc | Sound Prodcasts`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            اسم الدعم الفني : ANAS ALHARBI 
            message.channel.sendEmbed(help); // رابط السيرفر يعود الى سيرفر الادارة.
    }
});
